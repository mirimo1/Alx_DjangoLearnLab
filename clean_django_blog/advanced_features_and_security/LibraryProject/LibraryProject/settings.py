...
SECRET_KEY = 'django-insecure-^zc3pb2@xl6p$%q79la8935lfu4nxt81buyc#2j(v$**xy@l)@'
...
CSRF_COOKIE_SECURE = True     # Protect CSRF cookies
...
# SECURE_PROXY_SSL_HEADER: Ensures Django recognizes HTTPS requests forwarded by a proxy
